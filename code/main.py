...
from models.ffair import FFAIRModel
...
def parse_agrs():
    ...
    # Data input settings
    parser.add_argument('--image_dir', type=str, default='data/FFAIR', help='the path to the images.')
    parser.add_argument('--ann_path', type=str, default='data/fair_annotation.csv', help='the path to the annotation file.')
...
def main():
    ...
    model = FFAIRModel(args, tokenizer)
